...
std::map<std::string, std::vector<SimpleSettingData>> SettingsFactory::PART_CATEGORY_SETTINGS =
    {{L("Quality"),
      {{"ironing_type", "", 8},
       ...
       {"zaa_min_z", "", 4},
       {"zaa_bottom_enabled", "", 5},
       {"zaa_bottom_min_z", "", 6},
       {"zaa_bottom_minimize_perimeter_height", "", 7},
       {"zaa_bottom_dont_alternate_fill_direction", "", 8},
       {"zaa_support_interface_enabled", "", 9},
       {"zaa_support_interface_min_z", "", 10},
       {"zaa_disabled", "", 11}}},
     {L("Strength"),
      {{"wall_loops", "", 1},
